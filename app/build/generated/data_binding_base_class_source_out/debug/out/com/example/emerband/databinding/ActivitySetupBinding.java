...
public final class ActivitySetupBinding implements ViewBinding {
  ...
  private ActivitySetupBinding(@NonNull ConstraintLayout rootView, @NonNull Button continueButton,
      @NonNull TextView instructionTextView, @NonNull EditText nameEditText) {
  ...
  public static ActivitySetupBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySetupBinding((ConstraintLayout) rootView, continueButton,
          instructionTextView, nameEditText);
    }
