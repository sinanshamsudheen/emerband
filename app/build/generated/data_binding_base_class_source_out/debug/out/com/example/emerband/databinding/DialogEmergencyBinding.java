...
public final class DialogEmergencyBinding implements ViewBinding {
  ...
  private DialogEmergencyBinding(@NonNull LinearLayout rootView, @NonNull MaterialButton btnCancel,
      @NonNull MaterialButton btnProceed) {
  ...
  public static DialogEmergencyBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.dialog_emergency, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static DialogEmergencyBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogEmergencyBinding((LinearLayout) rootView, btnCancel, btnProceed);
    }
